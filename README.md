...
- **Payment Integration**: [Lenco](https://lenco.co/)
...
- A [Lenco Sandbox Account](https://sandbox.lenco.co/).
...
Create a new file named `.env.local` in the root of your project directory. Copy the contents of `.env.example` (if available) or add the following variables, replaci I'm ng the placeholder values with your actual credentials.
...
# Lenco Sandbox Credentials
# Get these from your Lenco Sandbox dashboard
LENCO_BASE_URL=https://sandbox.lenco.co/access/v2
LENCO_PUBLIC_KEY=pub-88dd921c0ecd73590459a1dd5a9343c77db0f3c344f222b9
LENCO_API_SECRET_KEY=993bed87f9d592566a6cce2cefd79363d1b7e95af3e1e6642b294ce5fc8c59f6
```
...
**Important**: Ensure you use the credentials for your **production** Supabase project and your **production** Lenco account when you are ready to go live.
