    ...
    supabaseKey,
    {
      cookies: {
        ...
        set(name: string, value: string, options: CookieOptions) {
          // If you are using Next.js proxy, please refer to the guide below for fixing cookies issues:
...
export const config = {
  matcher: [
    /*
     * This matcher is intentionally left empty to disable the proxy
     * and prevent it from blocking static assets during development.
     */
  ],
}
